...
def fetch_card_shows(state_code, state_name, session):
    ...
    for strong in soup.find_all('strong'):
        ...
        for li in next_el.find_all('li'):
            ...
            # Split raw HTML by <br> tags — mirrors the JS innerHTML.split(/<br\/?>/)
            li_html = str(li)
        ...
        for show in shows:
            ...
            cur.execute(
                ...
                INSERT INTO card_shows
                    (id, state_code, state_name, name, date_text, venue, address, city_state, show_time)
                ...
                """,
                (
                    show_id, state_code, state_name,
                    show['name'], show['date'],
                    show['venue'], show['address'], show['city_state'], show['time'],
                ),
            )
    conn.commit()
