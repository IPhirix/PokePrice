...
function AppRoutes() {
  ...
  if (isSetup === 'no-api') return (
    <div className="h-screen bg-surface-900 flex flex-col items-center justify-center gap-4 p-8 text-center">
      <svg className="w-14 h-14 text-accent/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
      <div>
        <p className="text-white font-bold text-xl mb-2">Desktop App Required</p>
        <p className="text-slate-400 text-sm max-w-xs">PokePrice is a desktop application and can't run in a browser. Download and install the app to get started.</p>
      </div>
    </div>
  )
