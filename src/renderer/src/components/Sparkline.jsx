...
function SparkTooltip({ active, payload }) {
  ...
  return (
    <div className="bg-surface-700 border border-surface-500 rounded px-2 py-1 text-xs pointer-events-none shadow-lg">
...
export default function Sparkline({ history, cardId, height = 56, showXAxis = false }) {
  ...
  if (trimmed.length <= 1) {
    return (
      <ResponsiveContainer width="100%" height={height}>
        <AreaChart data={PLACEHOLDER_DATA} margin={{ top: 4, right: 4, bottom: 0, left: 4 }}>
          <defs>
